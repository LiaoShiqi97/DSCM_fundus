This is Shiqi Liao's master thesis project Counterfactual inference on retina fundus images using deep structural causal models.


----------------------------------------
This Repository is following the DSCM strategy in paper below. For convience, I copy its README.file here.
TO run the experiment: try 
```
python -m deepscm.experiments.medical.trainer -e SVIExperiment -m ConditionalVISEM --default_root_dir /path/to/checkpoints --downsample 4 --decoder_type fixed_var --train_batch_size 128 {--gpus 0}
```
